...
public class AuthUtil {
  ...
  ///public static AppEngineDataStoreFactory appStore = new AppEngineCredentialStore();
  ...
  public static AuthorizationCodeFlow newAuthorizationCodeFlow() throws IOException {
    ...
    GoogleAuthorizationCodeFlow.Builder builder = new GoogleAuthorizationCodeFlow.Builder(
            ...
            clientSecret, 
            GLASS_SCOPE);
    builder.setCredentialStore(store);
  ...
  public static void setUserId(HttpServletRequest request, String userId) throws IOException {
    HttpSession session = request.getSession();
    session.setAttribute("userId", userId);
  }
  
  public static void storeUserIdCredential(String userId, Credential credential) throws IOException {
